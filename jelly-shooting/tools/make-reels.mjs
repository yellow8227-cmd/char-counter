...
const TABLE = {
  ...
  ko: [
    ...
    // 마무리 카드는 반드시 '끝에서부터' 센다(음수). 절대 시각으로 박았다가 51.2 를
    // 넣었는데, 거기는 마무리 카드가 아니라 결과 화면(우승!/게임 끝!/15200점)이었다.
    // 프레임을 보니 결과 화면 50~54 · 전환막 54.5 · 마무리 카드 55.5~58.8 이다.
    // 끝에서부터 세면 다시 구워 길이가 바뀌어도 늘 마무리를 잡는다.
    { name: '마무리 카드', from: -3.6, len: 3.6 },
  ],
