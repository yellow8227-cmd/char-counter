...
const TABLE = {
  ...
  // 영어 55.3초 — 백지 5.0·11.0·17.5~18.0·26.5~27.0·34.5~37.0·51.0
  //   제일 진한 곳: 보스 19.0~26.0 (229~255) · 던전 44.5~50.5 (208~243)
  //                 핵불닭 28.5~34.0 (203~217)
  en: [
    { name: 'giant boss',  from: 20.0, len: 3.4 },   // 훅
    { name: 'nuclear',     from: 29.0, len: 4.5 },
    // 44.5 는 던전이 아니라 결과 화면(Winner!/Game over!)이었다. 색폭 측정은
    // '백지가 아니다' 만 보고 '게임 플레이인지' 는 구분하지 못한다 — 프레임을
    // 실제로 뽑아 보고서야 알았다. 던전·던지기는 38.5~42.0 이다.
    { name: 'live dungeon',from: 38.6, len: 3.6 },
