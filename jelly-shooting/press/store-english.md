...
| **Cover image** | `press/upload/cover-itch.png` (630×500 @2x). ⚠️ Do **not** use `cover-1200x630.png` — that's the OG ratio (1.90:1) and itch crops it |
...
| itch cover 630×500 | `press/upload/cover-itch.png` (변형 A·B·C·D 도 같은 폴더) |
